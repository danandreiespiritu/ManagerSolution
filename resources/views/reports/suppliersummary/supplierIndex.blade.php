            ...
            <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-semibold text-gray-900">Supplier Summary Reports</h1>
                            <p class="mt-1 text-sm text-gray-600">View and manage your saved supplier summary reports</p>
                        </div>
                        <a href="{{ route('reports.supplier-summary.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg shadow-sm transition-colors">
