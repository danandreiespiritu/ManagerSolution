                    ...
                    <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                        ...
                        <div class="px-6 py-4 border-b border-gray-200">
                            <div class="flex items-center gap-2">
                                <h1 class="text-xl font-semibold text-gray-900">Supplier Statement Transactions</h1>
                        ...
                        <!-- Form -->
                        <div class="px-6 py-6">
                            <form method="POST" action="{{ route('reports.suppliers.statement-transactions.generate') }}" class="space-y-6">
                                @csrf
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label for="date_today" class="block text-sm font-medium text-gray-700 mb-2">Today</label>
                                        <input type="date" 
                                               id="date_today" 
                                               name="date_today" 
                                               value="{{ old('date_today', date('Y-m-d')) }}"
                                               class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                               required>
                                        @error('date_today')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                ...
                                <div class="flex items-center justify-between pt-4">
                                                <a href="{{ route('reports.suppliers.statement-transactions.index') }}" 
