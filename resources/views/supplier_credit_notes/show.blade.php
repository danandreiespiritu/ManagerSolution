...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mt-4 bg-white p-4 rounded border border-gray-200 shadow-sm text-gray-900">
        ...
        <p><strong>Date:</strong> {{ optional($note->credit_date)->format('Y-m-d') }}</p>
            ...
            <table class="w-full text-sm mt-2">
                ...
                @foreach($note->bills as $b)
                    ...
                    <tr class="border-b text-gray-900 hover:bg-gray-50">
                        <td class="py-2">
                            <a href="{{ route('supplierbills.show', $b->id) }}"
    ...
    <div class="mt-4">
        <a href="{{ route('suppliercreditnotes.edit', $note->id) }}"
           class="px-3 py-2 bg-blue-600 text-white rounded shadow hover:bg-blue-700">
            Edit
        </a>

        <form action="{{ route('suppliercreditnotes.destroy', $note->id) }}"
              method="POST"
